...
use Velolia\Container\Exception\ContainerException;
    ...
    protected function resolveDependencies(array $dependencies, array $parameters)
    {
        ...
        foreach ($dependencies as $dependency) {
            if (array_key_exists($dependency->getName(), $parameters)) {
                ...
                throw new ContainerException("Unresolvable dependency resolving [$dependency] in class {$dependency->getDeclaringClass()->getName()}");
            }
        }
    ...
    public function call($callback, array $parameters = [])
    {
        try {
            if (is_array($callback)) {
                ...
                // If first argument is already an object instance
                if (is_object($class)) {
                    $instance = $class;
                } else {
            ...
            // Get dependencies with better error handling
    ...
    */
    public function get(string $id): mixed
    {
        try {
            ...
            throw new ContainerException("Target [$id] is not registered with the container.");
        }
    }
